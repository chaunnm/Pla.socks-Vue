  ...
  <div class="wrapper">
    <div class="container">
      ...
      <div class="column">
        ...
        <div class="line-big"></div>
        <a class="link-page" href="#">Our story</a>
      ...
      <div class="column">
        ...
        <div class="line-small"></div>
        <a class="link-page" href="#">Socks For Summer</a>
        <div class="line-small"></div>
        <a class="link-page" href="#">Socks For Women</a>
        <div class="line-small"></div>
        <a class="link-page" href="#">Socks For Men</a>
        <div class="line-small"></div>
        <a class="link-page" href="#">Socks For Kids</a>
        <div class="line-small"></div>
      </div>
    ...
    <div class="payment">
      <div class="payment-icons">
        <div class="payment-icon">
          <svg width="40" height="20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 32">
            <path
...
.wrapper {
  ...
  .payment {
    ...
    &-icon {
      ...
      background-color: rgba(21, 103, 117, 0.8);
