  ...
  <div class="story">
    <div class="change-page">
      <div class="btn-group">
        ...
        <button
          @click="selected = 2"
          :class="selected === 2 ? 'active' : 'inactive'"
        >
          About Us
        </button>
        <button
          @click="selected = 3"
          :class="selected === 3 ? 'active' : 'inactive'"
        >
          Sustainability
        </button>
      </div>
    </div>
    <OurStoryVue v-if="selected === 1" />
    <AboutUsVue v-else-if="selected === 2" />
    <SustainabilityVue v-else />
